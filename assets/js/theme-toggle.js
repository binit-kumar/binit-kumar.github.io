    ...
    function applyTheme(theme) {
      if (theme === 'dark') {
        ...
        contactImages.forEach(img => {
          ...
          img.style.fill = getComputedStyle(body).getPropertyValue('--svg-fill-color-dark').trim(); // Dark theme color
        });
        ...
        contactImages.forEach(img => {
          ...
          img.style.fill = getComputedStyle(body).getPropertyValue('--svg-fill-color-light').trim(); // Light theme color
        });
        feedbackInputs.forEach(input => {
